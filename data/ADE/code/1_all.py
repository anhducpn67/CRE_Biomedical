...
def process_annotation_Entity_type(annotation, sent, token_list, entity_type_flag):
    ...
    for anno_item in annotation:
        ...
        for entity in entity_list:
            ...
            # entity_type_list = ["Disease_Symptom", "Drug"]
            # ["adverse_effect", "drug"]
            if entity_type=="adverse_effect":
                entity_type = "Disease"
            elif entity_type=="drug":
                entity_type = "Drug"
            else:
                raise Exception("entity type wrong !")
    ...
    for anno_item in annotation:
        if len(anno_item) == 3:
            ...
            if relation_tag=="ADE":
                ...
                raise Exception("relation wrong !")

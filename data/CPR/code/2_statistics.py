...
print("="*30, "REAL", "="*30)
train_file = "../BIOES/base/CPR_train_base_model_data.json"
valid_file = "../BIOES/base/CPR_valid_base_model_data.json"
test_file = "../BIOES/base/CPR_test_base_model_data.json"
...
print("="*30, "TEST", "="*30)
train_file = "../BIOES/base/test/CPR_train_base_model_data.json"
valid_file = "../BIOES/base/test/CPR_valid_base_model_data.json"
test_file = "../BIOES/base/test/CPR_test_base_model_data.json"
file_list = [train_file, valid_file, test_file]
for file in file_list:
    print("*****", file)
    statistics_corpus_entity(file)

def statistics_corpus_relation(file_path):
    ...
    relation_list = ["relation_" + str(i) for i in ["Drug_Drug_interaction"]]
    num_relation_dic = {}
...
def statistics_corpus_entity(file_path):
    ...
    entity_list = ["only_entity_type_" + str(i) for i in ["Drug"]]
    num_entity_dict = {}
...
valid_file = "../BIOES/base/DDI_valid_base_model_data.json"
test_file = "../BIOES/base/DDI_test_base_model_data.json"
...
print("="*30, "TEST", "="*30)
train_file = "../BIOES/base/test/DDI_train_base_model_data.json"
valid_file = "../BIOES/base/test/DDI_valid_base_model_data.json"
test_file = "../BIOES/base/test/DDI_test_base_model_data.json"
file_list = [train_file, valid_file, test_file]
for file in file_list:
    print("*****", file)
    statistics_corpus_entity(file)

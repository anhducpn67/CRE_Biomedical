def statistics_corpus_relation(file_path):
    ...
    relation_list = ["relation_" + str(i) for i in ["Drug_Disease_interaction"]]
    num_relation_dic = {}
...
def statistics_corpus_entity(file_path):
    ...
    entity_list = ["only_entity_type_" + str(i) for i in ["Drug", "Disease"]]
    num_entity_dict = {}
...
train_file = "../BIOES/base/Twi_ADE_train_base_model_data.json"
valid_file = "../BIOES/base/Twi_ADE_valid_base_model_data.json"
test_file = "../BIOES/base/Twi_ADE_test_base_model_data.json"

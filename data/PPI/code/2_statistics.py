def statistics_corpus_relation(file_path):
    ...
    relation_list = ["relation_" + str(i) for i in ["Gene_Gene_interaction"]]
    num_relation_dic = {}
...
def statistics_corpus_entity(file_path):
    ...
    entity_list = ["only_entity_type_" + str(i) for i in ["Gene"]]
    num_entity_dict = {}
...
train_file = "../BIOES/base/PPI_train_base_model_data.json"
valid_file = "../BIOES/base/PPI_valid_base_model_data.json"
test_file = "../BIOES/base/PPI_test_base_model_data.json"
